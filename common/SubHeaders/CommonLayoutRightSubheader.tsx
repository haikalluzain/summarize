      ...
      <ButtonGroup>
        <Dropdown>
          ...
          <DropdownMenu isAlignmentEnd>
            ...
            <DropdownItem>
              <NavLink href="/page-layouts/header-and-subheader">
                <Icon icon="LayoutTopPanel5" />
                Header & Subheader
              </NavLink>
            </DropdownItem>
            <DropdownItem>
              <NavLink href="/page-layouts/only-header">
            ...
            <DropdownItem>
              <NavLink href="/page-layouts/only-subheader">
            ...
            <DropdownItem>
              <NavLink href="/page-layouts/only-content">
