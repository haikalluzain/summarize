      ...
      <ReactApexChart
        options={{
          colors: [
            ...
            process.env.SUCCESS_COLOR,
            process.env.INFO_COLOR,
            process.env.WARNING_COLOR,
            process.env.DANGER_COLOR,
          ],
          plotOptions: {
            candlestick: {
              colors: {
                upward: process.env.SUCCESS_COLOR,
                downward: process.env.DANGER_COLOR,
              },
            },
            boxPlot: {
              colors: {
                upper: process.env.SUCCESS_COLOR,
                lower: process.env.DANGER_COLOR,
              },
            },
          },
          ...options,
